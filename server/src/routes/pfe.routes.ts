...
router.put('/:id', authenticateToken, upload.fields([{ name: 'report', maxCount: 1 }, { name: 'presentation', maxCount: 1 }]), updatePFE);
router.delete('/:id', authenticateToken, deletePFE);
